...
if (array_key_exists('nome_fantasia', $_POST) && array_key_exists('email', $_POST) && array_key_exists('senha', $_POST)) {
    ...
    if ($linha && password_verify($senhaDigitada, $linha['senha'])) {
        ...
        $empresas = $linha;
        // Usuário autenticado, redirecione para a página "cadastrar_empresa.php"
    ...
    // Dados de login ausentes, redirecione para a página "login_empresa.php"
