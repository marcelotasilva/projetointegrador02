...
<div class="table-container">
    <table id="customers">
        ...
        if (isset($_SESSION['id_usuario']) && is_numeric($_SESSION['id_usuario'])) {
            ...
            $consulta = $db->query("SELECT * FROM usuarios WHERE id_usuario = $id_usuario");
            ...
            echo "Sessão inválida. Verifique se está logado.";
        }
        ?>
    </table>
</div>
<form action="proc_apagar_cadastro.php" method="post">
    <h1>Tem certeza que deseja remover o cadastro?</h1><br>
    <button type="submit" class="bin" class="button">🗑</button>
    <div class="div">
        <small>
            <i></i>
        </small>
