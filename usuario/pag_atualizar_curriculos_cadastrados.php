...
if (isset($_SESSION['id_usuario'])) {
    ...
    $query = "SELECT curriculos.id_curriculo, curriculos.usuarios_id_usuario, curriculos.vagas_id_vaga , usuarios.nome, usuarios.email
              FROM curriculos
    ...
    if ($stmt->rowCount() > 0) {
        ...
        foreach ($curriculos as $curriculo) {
            ...
            echo "<td><a href='proc_atualizar_curriculo.php?id_curriculo=" . $curriculo['id_curriculo'] . "'>Atualizar Currículo</a></td>";
            echo "</tr>";
        }
        echo "</table>";
        echo "</div>";
